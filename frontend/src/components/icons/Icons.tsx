...
export const IconPlus = (props: {onClick: () => void}) => (
    <svg onClick={props.onClick} style={{paddingLeft: "0.5rem"}} xmlns="http://www.w3.org/2000/svg" width="30" height="16" fill="currentColor"
